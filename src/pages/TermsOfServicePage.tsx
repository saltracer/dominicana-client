      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="space-y-6">
          <Card className="border-amber-200 dark:border-amber-800 bg-white dark:bg-card">
            <CardHeader>
              <CardTitle className="font-garamond text-2xl text-dominican-black dark:text-foreground">
          ...
          <Card className="border-amber-200 dark:border-amber-800 bg-white dark:bg-card">
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="font-semibold text-dominican-black dark:text-foreground mb-2">Account Creation</h4>
              ...
              <div>
                <h4 className="font-semibold text-dominican-black dark:text-foreground mb-2">Accurate Information</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
              ...
              <div>
                <h4 className="font-semibold text-dominican-black dark:text-foreground mb-2">Account Security</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          <Card className="border-amber-200 dark:border-amber-800 bg-white dark:bg-card">
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="font-semibold text-dominican-black dark:text-foreground mb-2">Platform Content</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
              ...
              <div>
                <h4 className="font-semibold text-dominican-black dark:text-foreground mb-2">User-Generated Content</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
              ...
              <div>
                <h4 className="font-semibold text-dominican-black dark:text-foreground mb-2">Third-Party Content</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          <Card className="border-amber-200 dark:border-amber-800 bg-white dark:bg-card">
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="font-semibold text-dominican-black dark:text-foreground mb-2">Service Availability</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
              ...
              <div>
                <h4 className="font-semibold text-dominican-black dark:text-foreground mb-2">Spiritual Guidance</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
              ...
              <div>
                <h4 className="font-semibold text-dominican-black dark:text-foreground mb-2">Limitation of Liability</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
          ...
          <Card className="border-amber-200 dark:border-amber-800 bg-white dark:bg-card">
            ...
            <CardContent>
              ...
              <div className="mt-4 text-dominican-black dark:text-foreground">
