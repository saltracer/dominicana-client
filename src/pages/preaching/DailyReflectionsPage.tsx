      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="font-medium">{format(todaysReflection.date, "EEEE, MMMM d, yyyy")}</span>
          </div>
          ...
          <div className="mb-6">
            <p className="font-medium text-gray-700 mb-2">Scripture: {todaysReflection.scripture}</p>
            <div className="bg-dominican-light-gray/30 p-4 rounded-md italic">
              {todaysReflection.scriptureText}
            </div>
          </div>
          ...
          <div className="border-t border-dominican-light-gray pt-4 mt-6 text-right">
            <p className="italic text-gray-600">Written by {todaysReflection.author}</p>
          </div>
          
          {todaysReflection.audioUrl && (
            <div className="mt-6 bg-dominican-burgundy/10 p-4 rounded-md">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="space-y-4">
            <div className="border-b border-dominican-light-gray pb-3">
              <p className="text-sm text-gray-500 mb-1">{format(new Date(todaysReflection.date.setDate(todaysReflection.date.getDate() - 1)), "MMMM d, yyyy")}</p>
