        ...
        <div className="space-y-6">
          ...
          <Card className="border-amber-200 dark:border-amber-800 bg-white dark:bg-card">
            ...
            <CardContent className="space-y-4">
              <div>
                <h4 className="font-semibold text-dominican-black dark:text-foreground mb-2">Personal Information</h4>
              ...
              <div>
                <h4 className="font-semibold text-dominican-black dark:text-foreground mb-2">Usage Information</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
              ...
              <div>
                <h4 className="font-semibold text-dominican-black dark:text-foreground mb-2">Technical Information</h4>
                <p className="text-gray-700 dark:text-gray-300 text-sm">
