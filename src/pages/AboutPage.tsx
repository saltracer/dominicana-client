        ...
        <Card className="border-amber-200">
          ...
          <CardContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
              <div>
                <h4 className="font-semibold text-dominican-black mb-2">Friars</h4>
                <p className="text-sm text-gray-600">
                  Brothers dedicated to preaching, teaching, and pastoral ministry
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-dominican-black mb-2">Sisters</h4>
                <p className="text-sm text-gray-600">
                  Contemplative and apostolic sisters in monasteries and congregations
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-dominican-black mb-2">Laity</h4>
                <p className="text-sm text-gray-600">
