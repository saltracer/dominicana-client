...
const HomePage: React.FC = () => {
  return (
    <div className="animate-fade-in">
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-dominican-white dark:from-card to-white dark:to-background py-16 md:py-24">
      ...
      <section className="py-16 bg-white dark:bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-center font-garamond text-3xl md:text-4xl font-bold mb-2 text-dominican-black dark:text-foreground">
            The Four Pillars
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-dominican-white dark:bg-card p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">Deepen your spiritual life with the Liturgy of the Hours and the Holy Rosary.</p>
            ...
            <div className="bg-dominican-white dark:bg-card p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">Access classical Catholic texts and theological resources in our digital library.</p>
              <Button asChild variant="link" className="text-dominican-burgundy">
            ...
            <div className="bg-dominican-white dark:bg-card p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">Explore the liturgical calendar, Dominican saints, and provincial territories.</p>
              <Button asChild variant="link" className="text-dominican-burgundy">
            ...
            <div className="bg-dominican-white dark:bg-card p-6 rounded-lg shadow-md text-center">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-4">Find inspiration through daily reflections and preaching resources.</p>
              <Button asChild variant="link" className="text-dominican-burgundy">
      ...
      <section className="py-16 bg-dominican-light-gray/30 dark:bg-muted/50">
        <div className="container mx-auto px-4">
          <h2 className="text-center font-garamond text-3xl md:text-4xl font-bold mb-2 text-dominican-black dark:text-foreground">
            Featured Content
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-card rounded-lg overflow-hidden shadow-md">
              <div className="h-48 bg-dominican-burgundy/20 dark:bg-dominican-burgundy/30"></div>
              <div className="p-6">
                <h3 className="font-garamond text-xl font-bold text-dominican-burgundy mb-2">Today's Feast</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">Explore the significance of today's celebration in the liturgical calendar.</p>
            ...
            <div className="bg-white dark:bg-card rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">Learn about the tradition of the Rosary in the Dominican Order.</p>
                <Button asChild variant="outline" className="w-full border-dominican-burgundy text-dominican-burgundy hover:bg-dominican-burgundy/10">
            ...
            <div className="bg-white dark:bg-card rounded-lg overflow-hidden shadow-md">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm mb-4">Explore the lives and legacies of notable Dominican saints throughout history.</p>
                <Button asChild variant="outline" className="w-full border-dominican-burgundy text-dominican-burgundy hover:bg-dominican-burgundy/10">
