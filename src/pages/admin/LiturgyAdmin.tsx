...
import ComplineTemplateCreator from '@/components/admin/liturgy/ComplineTemplateCreator';
      ...
      <Card className="border-none shadow-md">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-1 md:grid-cols-4 bg-muted/50">
            ...
            <TabsTrigger value="compline">Compline Template</TabsTrigger>
          </TabsList>
