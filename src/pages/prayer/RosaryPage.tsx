  ...
  joyful: [
    {
      ...
      reflection:
        "Mary's humble acceptance of God's will is a model for our own response to God's call in our lives.",
    },
    {
      ...
      reflection:
        "Mary's service to Elizabeth reminds us of our call to serve others with joy and humility.",
    },
    {
      title: "The Nativity",
      ...
      reflection:
        "God humbles himself to be born in poverty, showing us the value of simplicity and humility.",
    },
    {
      ...
      reflection:
        "Simeon and Anna's recognition of the Christ child reminds us to be attentive to God's presence in our lives.",
    },
    {
      ...
      reflection:
        "Jesus shows his dedication to his Father's will, teaching us to prioritize our relationship with God.",
    },
  ],
  sorrowful: [
    {
      ...
      reflection:
        "Jesus' surrender to the Father's will teaches us to trust in God's plan even in our darkest moments.",
    },
    {
      title: "The Scourging at the Pillar",
      description:
        "Jesus is scourged at the pillar by order of Pontius Pilate.",
      scriptureRef: "John 19:1",
      reflection:
        "Christ's suffering reminds us of the cost of our redemption and the depth of God's love.",
    },
    {
      ...
      reflection:
        "Jesus bears the mockery of the soldiers with dignity, showing us how to respond to insults with patience.",
    },
    {
      ...
      reflection:
        "As Jesus carries his cross, we are reminded to embrace our own crosses with faith and courage.",
    },
    {
      ...
      reflection:
        "Jesus' ultimate sacrifice on the cross reveals the boundless extent of God's love for humanity.",
    },
  ],
  glorious: [
    {
      ...
      reflection:
        "Christ's resurrection gives us hope in the promise of eternal life and victory over sin and death.",
    },
    {
      title: "The Ascension",
      description:
      ...
      reflection:
        "As Jesus returns to the Father, he promises to send us the Holy Spirit and prepares a place for us.",
    },
    {
      ...
      reflection:
        "The coming of the Holy Spirit empowers us to bear witness to Christ in the world.",
    },
    {
      ...
      reflection:
        "Mary's assumption gives us hope in our own bodily resurrection at the end of time.",
    },
    {
      ...
      scriptureRef: "Revelation 12:1",
      reflection:
        "Mary's coronation reminds us of her role as our intercessor and the glory that awaits the faithful.",
    },
  ],
  luminous: [
    {
      ...
      reflection:
        "Jesus' baptism reveals his identity as the beloved Son and inaugurates his public ministry.",
    },
    {
      title: "The Wedding at Cana",
      description:
        "Jesus performs his first miracle at the wedding feast in Cana.",
      scriptureRef: "John 2:1-12",
      reflection:
        "Through Mary's intercession, Jesus transforms water into wine, showing his power to transform our lives.",
    },
    {
      title: "The Proclamation of the Kingdom",
      description:
        "Jesus proclaims the Kingdom of God and calls all to conversion.",
      scriptureRef: "Mark 1:14-15",
      reflection:
        "Jesus' call to conversion challenges us to align our lives with the values of God's Kingdom.",
    },
    {
      ...
      reflection:
        "The Transfiguration gives us a glimpse of Christ's glory and strengthens our faith in difficult times.",
    },
    {
      ...
      reflection:
        "In the Eucharist, Jesus gives himself to us as spiritual food for our journey of faith.",
    },
  ],
};
...
const RosaryPage: React.FC = () => {
  ...
  const [isDominican, setIsDominican] = useState<boolean>(true);

  const rosarySteps = isDominican ? dominicanRosarySteps : standardRosarySteps;
  const mysteriesStepIndex = rosarySteps.findIndex(
    (step) => step.name === "Mysteries",
  );

  const handleNext = () => {
    if (activeStep < mysteriesStepIndex) {
      setActiveStep(activeStep + 1);
    } else if (activeStep === mysteriesStepIndex) {
      if (activeMystery < mysteries[activeSet].length - 1) {
        setActiveMystery(activeMystery + 1);
      } else {
        setActiveStep(activeStep + 1);
        setActiveMystery(0);
      }
    } else if (activeStep < rosarySteps.length - 1) {
      setActiveStep(activeStep + 1);
    } else {
      // End of rosary
      setPraying(false);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="font-garamond text-3xl md:text-4xl font-bold text-dominican-burgundy mb-2 text-center md:text-left">
        The Rosary
      </h1>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between mb-6">
        <p className="text-gray-700 mb-4 md:mb-0 max-w-3xl">
          The Rosary has a special place in Dominican spirituality. St. Dominic
          is traditionally believed to have received the Rosary from the Blessed
          Virgin Mary as a powerful spiritual weapon.
        </p>
        ...
        <div className="flex items-center space-x-2 bg-white p-2 rounded-md shadow-sm">
          <Label
            ...
            className={cn(
              "text-sm",
              isDominican ? "text-dominican-burgundy" : "text-gray-500",
            )}
          >
            Standard
          </Label>
          <Switch
            id="rosary-type"
            checked={isDominican}
            onCheckedChange={setIsDominican}
            className="data-[state=checked]:bg-dominican-burgundy"
          />
          <Label
            htmlFor="rosary-type"
            className={cn(
              "text-sm",
              isDominican ? "text-gray-900 font-medium" : "text-gray-500",
            )}
          >
            Dominican
          </Label>
      ...
      {!praying ? (
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <Tabs
            defaultValue="joyful"
            className="w-full"
            onValueChange={(value) => setActiveSet(value as any)}
          >
            ...
            <TabsContent value="joyful" className="p-4">
              <p className="mb-4 text-gray-600">
                The Joyful Mysteries are traditionally prayed on Mondays and
                Saturdays, and focus on the events surrounding Christ's birth
                and childhood.
              </p>
              <ul className="list-disc pl-5 mb-6">
                {mysteries.joyful.map((mystery, index) => (
                  <li key={index} className="mb-2">
                    <span className="font-medium">{mystery.title}</span> -{" "}
                    {mystery.description}
                  </li>
                ))}
              </ul>
            ...
            <TabsContent value="luminous" className="p-4">
              <p className="mb-4 text-gray-600">
                ...
                and focus on Christ's public ministry.
              </p>
              <ul className="list-disc pl-5 mb-6">
            ...
            <TabsContent value="sorrowful" className="p-4">
              <p className="mb-4 text-gray-600">
                The Sorrowful Mysteries are traditionally prayed on Tuesdays and
                Fridays, and focus on Christ's Passion and death.
              </p>
              <ul className="list-disc pl-5 mb-6">
            ...
            <TabsContent value="glorious" className="p-4">
              <p className="mb-4 text-gray-600">
                The Glorious Mysteries are traditionally prayed on Wednesdays
                and Sundays, and focus on Christ's Resurrection and the events
                that followed.
              </p>
              <ul className="list-disc pl-5 mb-6">
          ...
          <div className="flex justify-center md:justify-start">
            ...
            >
              Begin {isDominican ? "Dominican" : "Standard"} Rosary
            </Button>
          </div>
        </div>
      ) : (
        <div className="bg-white rounded-lg shadow-md p-6">
          {activeStep !== mysteriesStepIndex ? (
            ...
            <div className="animate-fade-in">
              ...
              <p className="text-gray-600 mb-4">
                {activeMystery + 1} of 5 |{" "}
                {activeSet.charAt(0).toUpperCase() + activeSet.slice(1)}{" "}
                Mysteries
              </p>
              ...
              <div className="mb-6">
                <div className="bg-dominican-light-gray/30 p-6 rounded-md mb-4">
                  <p className="mb-2">
                    {mysteries[activeSet][activeMystery].description}
                  </p>
                  <p className="italic text-sm text-gray-600">
                    Scripture:{" "}
                    {mysteries[activeSet][activeMystery].scriptureRef}
                  </p>
                </div>
              ...
              <div className="flex justify-between">
                ...
                <Button
                  ...
                  className="bg-dominican-burgundy hover:bg-dominican-burgundy/90"
                >
                  {activeMystery < 4 ? "Next Mystery" : "Continue"}{" "}
          ...
          <div className="mt-8">
            <div className="flex justify-center items-center space-x-1">
              {rosarySteps.map((_, index) => {
                if (index === mysteriesStepIndex) {
                  // For mysteries, show 5 dots
                  return (
                    <div key={`mystery-group`} className="flex space-x-1">
                      {Array.from({ length: 5 }).map((_, mysteryIndex) => (
                        <div
                          key={`mystery-${mysteryIndex}`}
                          className={cn(
                            "h-2 w-2 rounded-full",
                            activeStep === mysteriesStepIndex &&
                              activeMystery === mysteryIndex
                              ? "bg-dominican-burgundy"
                              : activeStep === mysteriesStepIndex &&
                                  activeMystery > mysteryIndex
                                ? "bg-dominican-gold"
                                : activeStep > mysteriesStepIndex
            ...
            <p className="text-xs text-center text-gray-500 mt-2">
              {activeStep === mysteriesStepIndex
                ? `Mystery ${activeMystery + 1} of 5`
                : `Step ${activeStep + 1} of ${rosarySteps.length}`}
            </p>
          </div>
        </div>
      )}
