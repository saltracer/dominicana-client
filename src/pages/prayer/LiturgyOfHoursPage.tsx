  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shadow-md">
        <div className="flex items-center gap-2 p-4 border-b border-dominican-light-gray">
          <Calendar className="h-5 w-5 text-dominican-burgundy" />
          <span className="font-medium">Today: Friday, May 17, 2024</span>
        </div>
        ...
        <Tabs defaultValue="office-of-readings" className="w-full">
          ...
          <TabsContent value="night-prayer" className="p-6">
            ...
            <div className="text-center py-10">
              <p className="text-gray-600">Night Prayer content will be available soon.</p>
            </div>
          </TabsContent>
        </Tabs>
      </div>
