      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              <div className="space-y-3 mb-6">
                <div className="bg-amber-50 p-3 rounded">
                  <div className="flex justify-between items-center">
                    <span className="font-medium text-dominican-black">Today's Reading</span>
                    <span className="text-xs text-gray-600">Gospel Reflection</span>
                  </div>
                  <p className="text-sm text-gray-600 mt-1">Meditation on the Word of God</p>
                </div>
                <div className="text-sm text-gray-600">• Scripture-based reflections</div>
                <div className="text-sm text-gray-600">• Dominican saint inspirations</div>
                <div className="text-sm text-gray-600">• Theological insights</div>
              </div>
          ...
          <Card className="border-amber-200 hover:shadow-lg transition-shadow">
            ...
            <CardContent>
              ...
              <div className="space-y-3 mb-6">
                <div className="bg-amber-50 p-3 rounded">
                  <h4 className="font-semibold text-dominican-black mb-1">Liturgical Year Themes</h4>
                  <p className="text-sm text-gray-600">Seasonal preaching guides</p>
                </div>
                <div className="bg-amber-50 p-3 rounded">
                  <h4 className="font-semibold text-dominican-black mb-1">Scripture Commentary</h4>
                  <p className="text-sm text-gray-600">Exegetical insights for preachers</p>
                </div>
                <div className="bg-amber-50 p-3 rounded">
                  <h4 className="font-semibold text-dominican-black mb-1">Dominican Wisdom</h4>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-garamond text-xl font-semibold mb-3">From the Heart</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-garamond text-xl font-semibold mb-3">Truth & Clarity</h3>
                <p className="text-gray-700 text-sm">
              ...
              <div className="text-center">
                <Flame className="mx-auto mb-4 text-dominican-black" size={32} />
                <h3 className="font-garamond text-xl font-semibold mb-3">Pastoral Zeal</h3>
                <p className="text-gray-700 text-sm">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="text-center p-4 bg-amber-50 rounded">
                <h4 className="font-garamond font-semibold text-dominican-black mb-2">St. Dominic</h4>
                <p className="text-xs text-gray-600">Founder & Model Preacher</p>
                <p className="text-xs text-gray-500 mt-1">"Preaching against heresy"</p>
              </div>
              <div className="text-center p-4 bg-amber-50 rounded">
                <h4 className="font-garamond font-semibold text-dominican-black mb-2">St. Vincent Ferrer</h4>
                <p className="text-xs text-gray-600">Angel of the Judgment</p>
                <p className="text-xs text-gray-500 mt-1">"Prepare ye the way"</p>
              </div>
              <div className="text-center p-4 bg-amber-50 rounded">
                <h4 className="font-garamond font-semibold text-dominican-black mb-2">Bl. Fra Angelico</h4>
                <p className="text-xs text-gray-600">Preaching through Art</p>
                <p className="text-xs text-gray-500 mt-1">"Beauty of Truth"</p>
              </div>
              <div className="text-center p-4 bg-amber-50 rounded">
                <h4 className="font-garamond font-semibold text-dominican-black mb-2">St. Louis de Montfort</h4>
                <p className="text-xs text-gray-600">Marian Preacher</p>
                <p className="text-xs text-gray-500 mt-1">"True Devotion"</p>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-amber-50 p-6 rounded">
                  <h3 className="font-garamond text-lg font-semibold text-dominican-black mb-3">Preparation</h3>
                ...
                <div className="bg-amber-50 p-6 rounded">
                  <h3 className="font-garamond text-lg font-semibold text-dominican-black mb-3">Delivery</h3>
                  <ul className="space-y-2 text-sm text-gray-700">
        ...
        <Card className="border-amber-200 bg-gradient-to-r from-amber-50 to-orange-100">
          <CardContent className="text-center py-8">
            ...
            <p className="text-sm text-gray-500 mt-2">On the Art of Preaching</p>
          </CardContent>
        </Card>
      </div>
    </div>
