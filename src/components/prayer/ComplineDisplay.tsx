...
import { ComplineService } from '@/lib/liturgical/compline/compline-service';
import { ComplineComponent, ComplineTemplate } from '@/lib/liturgical/compline/compline-data';
