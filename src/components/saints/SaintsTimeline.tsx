...
const SaintsTimeline: React.FC<SaintsTimelineProps> = ({ 
  ...
  const timelineSaints = saints
    .filter(saint => saint.birth_year && saint.death_year)
  ...
  return (
    <div className="space-y-8">
      ...
      {Object.entries(centuryGroups)
        .sort(([a], [b]) => Number(a) - Number(b))
        .map(([century, saints]) => (
          <div key={century} className="relative">
            <div className="sticky top-4 z-10 bg-white/90 backdrop-blur-sm rounded-lg p-3 mb-4 border border-dominican-light-gray">
                  ...
                  <div key={saint.id} className="relative flex items-start">
                    ...
                    <div className={cn(
                      ...
                      saint.is_dominican 
                        ...
                        : "bg-dominican-gold text-dominican-black"
                    )}>
                    ...
                    <div 
                      className={cn(
                        ...
                        selectedSaint?.id === saint.id 
                          ? "border-dominican-burgundy bg-dominican-burgundy/5" 
                          : "border-dominican-light-gray bg-white hover:border-dominican-burgundy/30"
                      )}
                    ...
                    >
                      <div className="flex justify-between items-start mb-2">
                        <h5 className={cn(
                          ...
                          selectedSaint?.id === saint.id 
                            ? "text-dominican-burgundy" 
                            : "text-dominican-black"
                        )}>
                          {saint.name}
                        </h5>
