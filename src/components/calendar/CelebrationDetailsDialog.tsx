      ...
      >
        <AlertDialogHeader>
          <div className={cn(
            ...
            getColorClasses(celebration.color)
          )}>
          ...
          <div className="flex flex-wrap justify-between items-center mb-3">
            ...
            {celebration.isDominican && (
              <span className="bg-dominican-burgundy/10 text-dominican-burgundy text-sm px-2 py-0.5 rounded-md">
                Dominican Feast
              </span>
            )}
          </div>
            ...
            <div className="text-black">
              ...
              {celebration.biography && (
                <>
                  ...
                  {celebration.biography.map((paragraph, index) => (
                    <p key={index} className="text-gray-700 mb-3">{paragraph}</p>
                  ))}
                </>
              )}
              ...
              {celebration.books && celebration.books.length > 0 && (
                <>
                  ...
                  <ul className="space-y-1">
                    {celebration.books.map((book, index) => (
